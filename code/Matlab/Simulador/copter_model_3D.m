...
A.Body1 = patch('xdata',A.Body1X,'ydata',A.Body1Y,'zdata',A.Body1Z,'facealpha',.5,'facecolor','b');
A.Body2 = patch('xdata',A.Body2X,'ydata',A.Body2Y,'zdata',A.Body2Z,'facealpha',.5,'facecolor','b');
