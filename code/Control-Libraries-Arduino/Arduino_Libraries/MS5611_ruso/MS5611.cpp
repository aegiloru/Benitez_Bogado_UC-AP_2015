...
double MS5611::getAltitude(double pressure, double seaLevelPressure, double Temp)
{
    return (((273.15+Temp)/0.0065) * (1.0f - pow((double)pressure / (double)seaLevelPressure, 0.1902949f)));
}
